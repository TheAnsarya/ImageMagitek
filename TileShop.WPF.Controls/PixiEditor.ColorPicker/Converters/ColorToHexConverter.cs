...
internal class ColorToHexConverter : DependencyObject, IValueConverter {
	...
	public void RaiseShowAlphaChange() => OnShowAlphaChange(this, EventArgs.Empty);

	private static void ShowAlphaChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e) => ((ColorToHexConverter)d).RaiseShowAlphaChange();
