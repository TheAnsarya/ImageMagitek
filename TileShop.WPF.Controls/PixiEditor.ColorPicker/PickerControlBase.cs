...
public class PickerControlBase : UserControl, IColorStateStorage {
	...
	private static void OnColorStatePropertyChange(DependencyObject d, DependencyPropertyChangedEventArgs args) => ((PickerControlBase)d).Color.UpdateEverything((ColorState)args.OldValue);
