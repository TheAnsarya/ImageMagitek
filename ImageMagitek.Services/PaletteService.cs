...
public class PaletteService : IPaletteService {
	...
	public PaletteService(IColorFactory colorFactory) => ColorFactory = colorFactory;
	...
	public Palette ReadJsonPalette(string paletteFileName) {
		...
		var json = File.ReadAllText(paletteFileName);
	...
	public void SetNesPalette(Palette nesPalette) => NesPalette = nesPalette;
}
