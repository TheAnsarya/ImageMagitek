...
public static class ElementCopyExtensions {
	public static ArrangerCopy ToPixelCopy(this ElementCopy copy) {
		var x = copy.X * copy.Source.ElementPixelSize.Width;
		var y = copy.Y * copy.Source.ElementPixelSize.Height;
		var width = copy.Width * copy.Source.ElementPixelSize.Width;
		var height = copy.Height * copy.Source.ElementPixelSize.Height;
