...
public sealed class CodecFactory : ICodecFactory {
		...
		_codecs = new Dictionary<string, Type>
			{
                ...
                //{ "Rgb24 Tiled", typeof(Rgb24TiledCodec) }, { "Rgba32 Tiled", typeof(Rgba32TiledCodec) }, 
	...
	public IGraphicsCodec CloneCodec(IGraphicsCodec codec) => GetCodec(codec.Name, new Size(codec.Width, codec.Height));

	public IEnumerable<string> GetSupportedCodecNames() => _formats.Keys
			.Concat(_codecs.Keys)
			.OrderBy(x => x);
}
