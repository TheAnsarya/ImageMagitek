...
public class ColorConverterNes : IColorConverter<ColorNes> {
	...
	public ColorConverterNes(Palette nesPalette) => _nesPalette = nesPalette;
	...
	public ColorRgba32 ToNativeColor(ColorNes fc) => _nesPalette.GetNativeColor((int)fc.Color);
}
