...
public class ColorFactory : IColorFactory {
	...
	public IColor CreateColor(ColorModel colorModel, uint color) => colorModel switch {
	...
	public IColor CreateColor(ColorModel colorModel, int r, int g, int b, int a) => colorModel switch {
	...
	public IColor CloneColor(IColor color) => color switch {
	...
	public ColorRgba32 ToNative(IColor color) => color switch {
	...
	public IColor ToForeign(ColorRgba32 color, ColorModel colorModel) => colorModel switch {
	...
	public string ToHexString(IColor color) => color switch {
