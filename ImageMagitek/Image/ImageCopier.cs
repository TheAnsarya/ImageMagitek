...
public static class ImageCopier {
	...
	public static MagitekResult CopyPixels(IndexedPixelCopy source, IndexedImage dest, Point destStart, params PixelRemapOperation[] operationAttempts) => CopyPixels(source.Image, dest, new Point(0, 0), destStart, source.Width, source.Height, operationAttempts);
